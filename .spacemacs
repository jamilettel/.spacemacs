  ...
  (setq-default
   ...
   '(haskell
     ...
     (c-c++ :variables
            ...
            c-c++-dap-adapters '(dap-gdb-lldb dap-cpptools dap-lldb)
            dap-gdb-lldb-path "/home/jamil/.emacs.d/"
            )
...
before packages are loaded."
  (define-key evil-emacs-state-map (kbd "C-`") 'spacemacs/projectile-shell-pop)
  (define-key evil-emacs-state-map (kbd "C-<tab>") 'other-window)
  (define-key evil-emacs-state-map (kbd "C-<iso-lefttab>") 'prev-window)
  ...
  (define-key evil-emacs-state-map (kbd "C-x 2") 'split-and-follow-horizontally)
  (define-key evil-emacs-state-map (kbd "C-x 3") 'split-and-follow-vertically)
  ...
  (define-key evil-emacs-state-map (kbd "M-m p a") 'projectile-find-other-file)
  (define-key evil-emacs-state-map (kbd "C-w") 'whole-line-or-region-kill-region)
  (define-key evil-emacs-state-map (kbd "C-x g") 'magit-status)
  (define-key evil-emacs-state-map (kbd "C-c d") 'lsp-ui-doc-show)
  (define-key evil-emacs-state-map (kbd "M-<up>") 'move-text-line-up)
  (define-key evil-emacs-state-map (kbd "M-<down>") 'move-text-line-down)
  (define-key evil-emacs-state-map (kbd "M-m p s") 'counsel-projectile-ag)
  (define-key evil-emacs-state-map (kbd "<escape>") 'god-mode-all)
  (add-hook 'js2-mode-hook (lambda () (local-set-key (kbd "M-m m D") 'js-doc-insert-function-doc)))
  ...
  (add-hook 'treemacs-mode-hook (lambda () (treemacs-git-mode 'extended)))
